...
export default function ContactSection({ company = {}, socialMedia = [], officeHours = '', supportEmail = '' }) {
  return (
    <section className="py-16 bg-white border-t border-gray-100">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          >
            <h3 className="text-xl font-bold text-gray-800 mb-6">公司資訊</h3>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  <p className="font-medium text-gray-800">{company.name || 'PCB瑕疵檢測公司'}</p>
                  <p className="text-gray-600">{company.address || '載入中...'}</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <p className="font-medium text-gray-800">電子郵件</p>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">{officeHours || '週一至週五 09:00-18:00'}</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <p className="font-medium text-gray-800">技術支援</p>
            ...
            {/* 社群媒體連結 */}
            <div className="mt-8">
              <h4 className="text-lg font-medium text-gray-800 mb-3">關注我們</h4>
          ...
          >
            <h3 className="text-xl font-bold text-gray-800 mb-6">發送訊息</h3>
